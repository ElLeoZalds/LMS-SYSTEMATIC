    ...
    @if($role === 'teacher')
        <div class="mb-4">
            ...
            <ul class="nav flex-column gap-1 mb-3">
                <li><a href="{{ route('explore-courses.dashboard') }}" class="nav-link d-flex align-items-center gap-3 {{ request()->routeIs('explore-courses.dashboard') ? 'active' : '' }}"><i class="fa fa-compass fa-lg"></i> <span>Explorar cursos</span></a></li>
                <li><a href="{{ route('courses.index') }}" class="nav-link d-flex align-items-center gap-3 {{ request()->routeIs('courses.index') ? 'active' : '' }}"><i class="fa fa-chalkboard-teacher fa-lg"></i> <span>Administrar cursos</span></a></li>
            </ul>
        </div>
    @endif
    ...
    @if($role === 'admin')
        <div class="mb-4">
            ...
            <ul class="nav flex-column gap-1 mb-3">
                ...
                <li><a href="{{ route('courses.report') }}" class="nav-link d-flex align-items-center gap-3 {{ request()->routeIs('courses.report') ? 'active' : '' }}"><i class="fa fa-file-alt fa-lg"></i> <span>Reportes de cursos</span></a></li>
                <li><a href="{{ route('reportes.especialidades') }}" class="nav-link d-flex align-items-center gap-3 {{ request()->routeIs('reportes.especialidades') ? 'active' : '' }}"><i class="fa fa-chart-pie fa-lg"></i> <span>Reportes de especialidades</span></a></li>
            </ul>
        </div>
    @endif
