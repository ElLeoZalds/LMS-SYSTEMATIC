            ...
            @foreach($trainings as $training)
                <div class="col-12 col-md-6 col-lg-4">
                    <a href="{{ route('teacher.courses.show', $training->training_id) }}" class="text-decoration-none">
                        <div class="card h-100 shadow-sm rounded-3 border-0 position-relative overflow-hidden transition-all" style="transition: box-shadow 0.3s, transform 0.3s;">
                            
                            <!-- Gradient Header -->
                            <div class="bg-primary bg-gradient p-5 text-white d-flex align-items-center justify-content-center" style="height: 140px; font-size: 3rem; font-weight: bold; opacity: 0.9;">
