            ...
            <div class="col-12">
                <div class="card shadow-sm rounded-3 border-0">
                    <div class="card-body">
                        ...
                        @if(request()->routeIs('student.*') && !$hasEnrollments)
                            <div class="text-center py-5">
                                <i class="bi bi-calendar3 text-primary" style="font-size: 3rem;"></i>
                                <h5 class="card-title mt-4 text-dark fw-bold">Sin actividades programadas</h5>
                                <p class="text-muted mb-0">Todavía no tienes cursos inscritos, por lo que aún no existen clases o eventos en tu calendario.</p>
                            </div>
                        @else
