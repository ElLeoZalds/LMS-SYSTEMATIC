...
@section('content')
    <div class="container-fluid px-4 py-1">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="h3 mb-0 text-gray-800">Crear Módulo</h1>
        </div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.modules.store') }}">
                    ...
                    <div class="form-group form-check">
                        ...
                        <input type="checkbox" name="is_active" id="is_active" value="1" class="form-check-input @error('is_active') is-invalid @enderror" {{ old('is_active', true) ? 'checked' : '' }}>
