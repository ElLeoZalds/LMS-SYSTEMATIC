            ...
            <div class="col-12">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a href="{{ route('dashboard.calendario', ['view' => 'week', 'date' => $selectedDate->toDateString()]) }}"
                            class="btn {{ $viewMode === 'week' ? 'btn-primary' : 'btn-outline-primary' }} btn-sm">Ver
                            semana</a>
                        <a href="{{ route('dashboard.calendario', ['view' => 'month', 'date' => $selectedDate->toDateString()]) }}"
                            class="btn {{ $viewMode === 'month' ? 'btn-primary' : 'btn-outline-secondary' }} btn-sm">Ver
                            mes</a>
                    ...
                    <div class="card-body">
                        <div
                            ...
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('dashboard.calendario', ['view' => $viewMode, 'date' => $prevDate]) }}"
                                    class="btn btn-outline-secondary">Anterior</a>
                                <a href="{{ route('dashboard.calendario', ['view' => $viewMode, 'date' => $nextDate]) }}"
