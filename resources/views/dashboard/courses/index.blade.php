        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('cursos.destroy', $course->idcurso) }}" method="POST" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Seguro de eliminar este curso?')">Eliminar</button>
                    </form>
                </td>
            </tr>
            @endforeach
